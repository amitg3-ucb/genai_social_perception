...
if 'Tweet Quantity and Sentiment Over Time' in panels:
    ...
    # Read in Data
    df = pickle.load(open('tweets_with_sentiment.pkl','rb'))
...
if 'Hashtag Communities as a Network' in panels:
    ...
    hashtag_chart = pickle.load(open('hashtag_cooccurence_network.pkl','rb'))
    clustered_results_final = pickle.load(open('interpretable_hashtag_labels.pkl','rb'))
    network_weights = pickle.load(open('final_hashtag_adjacency_weights.pkl','rb'))
    ...
    final_color_codes = pickle.load(open('network_colors.pkl','rb'))
